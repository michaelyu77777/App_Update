...
func allLastVersionApksAPIHandler(w http.ResponseWriter, r *http.Request) {
	...
	// 選資料庫與collection
	cursor, err := mongoClientPointer.Database(`Apps_Update`).Collection(`appsInformation`).Find(context.TODO(), bson.M{
		"projectName": "教育訓練",
		"appName":     "教育訓練語音Service",
		// "lastVersion":  "0.1.0",
		// "packageName":  "com.leapsy.dspotterserviceforeducationtraining",
		// "downloadPath": "http://61.220.128.128:5005/appUpdate/download/1",
	}) //找全部
